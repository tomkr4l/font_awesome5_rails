...
describe FontAwesome5Rails do
  ...
  describe 'files' do
    context 'correct folders' do
      it { expect(Dir.exist?('./app/assets/images')).to be_truthy }
      it { expect(Dir.exist?('./app/assets/images/fa5/brands')).to be_truthy }
      it { expect(Dir.exist?('./app/assets/images/fa5/regular')).to be_truthy }
      it { expect(Dir.exist?('./app/assets/images/fa5/solid')).to be_truthy }
      it { expect(Dir.exist?('./app/assets/javascripts')).to be_truthy }
      it { expect(Dir.exist?('./app/assets/stylesheets')).to be_truthy }
      it { expect(Dir.exist?('./app/helpers/font_awesome5/rails')).to be_truthy }
    end

    context 'correct files' do
      it { expect(File.exist?('./app/helpers/font_awesome5/rails/icon_helper.rb')).to be_truthy }
      it { expect(File.exist?('./app/assets/javascripts/font_awesome5.js')).to be_truthy }
      it { expect(File.exist?('./app/assets/javascripts/all.min.js')).to be_truthy }
      it { expect(File.exist?('./app/assets/stylesheets/svg-with-js.min.css')).to be_truthy }
      it { expect(File.exist?('./app/assets/stylesheets/font_awesome5.css')).to be_truthy }
      it { expect(File.exist?('./app/assets/stylesheets/all.scss')).to be_truthy }
      it { expect(File.exist?('./app/assets/stylesheets/font_awesome5_webfont.scss')).to be_truthy }
      it { expect(File.exist?('./lib/font_awesome5_rails/engine.rb')).to be_truthy }
      it { expect(File.exist?('./lib/font_awesome5_rails/version.rb')).to be_truthy }
      it { expect(File.exist?('./lib/font_awesome5/rails/icon_helper/fa_icon_parser.rb')).to be_truthy }
      it { expect(File.exist?('./lib/font_awesome5/rails/icon_helper/fa_layered_icon_parser.rb')).to be_truthy }
      it { expect(File.exist?('./lib/font_awesome5/rails/icon_helper/fa_stacked_icon_parser.rb')).to be_truthy }
      it { expect(File.exist?('./lib/font_awesome5/rails/icon_helper/parse_methods.rb')).to be_truthy }
    end
  end
