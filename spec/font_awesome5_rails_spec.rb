...
describe FontAwesome5Rails do
  ...
  describe 'files' do
    ...
    it 'should have correct files' do
      ...
      expect(File.exists?('./app/assets/javascripts/all.js')).to be_truthy
      expect(File.exists?('./app/assets/stylesheets/svg-with-js.css')).to be_truthy
      expect(File.exists?('./app/assets/stylesheets/font_awesome5.css')).to be_truthy
      expect(File.exists?('./app/assets/stylesheets/all.css.scss')).to be_truthy
    ...
    it 'should not include requestAnimationFrame' do
      expect(File.foreach('./app/assets/javascripts/all.js').grep(/requestAnimationFrame/).any?).to be_falsey
    end
  end
